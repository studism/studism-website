  ...
  return (
    <div ref={ref} className="relative">
      <button
        ...
        style={{ color: open ? '#7C3AED' : '#64748B' }}
      >
        News
  ...
  return (
    <header className="sticky top-0 z-50 transition-all duration-300"
      style={{
        ...
        borderBottom: `1px solid ${scrolled ? '#EDE9FE' : 'transparent'}`,
        boxShadow: scrolled ? '0 4px 24px rgba(124,58,237,0.08)' : 'none',
      }}>
      <div className="container mx-auto px-6 md:px-12 lg:px-20 py-4 flex items-center justify-between">
        ...
        <nav className="hidden md:flex items-center gap-1">
          <a href="/"
            className="px-4 py-2 rounded-xl text-sm font-bold transition-all duration-200 hover:bg-purple-50 hover:text-purple-700"
            style={{ color: '#64748B' }}>
            Home
          </a>
          <NewsDropdown />
